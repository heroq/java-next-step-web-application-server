...
### requirements-4: redirect 방식으로 이동
...
### test-junit5: 책 참고 없이 리팩터링 및 테스트 코드 작성
...
### refactor-1,2: 요청 처리 분리, 리팩터링 2 (refactor-2) - 응답 처리 분리
